                ...
                <div class="card-body">
                    <form action="/user" method="post">
                        <div class="mb-3">
                            ...
                            <input name="fullname" type="text" class="form-control" id="fullnameInput" placeholder="Nama Lengkap">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" class="form-control" id="addressTexarea" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="dobInput" class="form-label">Tanggal Lahir</label>
                            <input name="dob" type="date" class="form-control" id="dobInput" placeholder="Tanggal Lahir">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input name="status" class="form-check-input" type="checkbox" value="1" id="statusCheckbox">
